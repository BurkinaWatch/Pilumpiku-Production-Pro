  ...
  return (
    ...
    >
      ...
      >
        ...
        <ellipse cx="14" cy="14" rx="1.1" ry="4.5" fill="#C97A10" />
        <circle cx="14" cy="8.8" r="1.9" fill="#C97A10" />
        <circle cx="13.2" cy="7.8" r="0.55" fill="#fff" />
        <circle cx="14.8" cy="7.8" r="0.55" fill="#fff" />
      </svg>
    </div>
  );
}
